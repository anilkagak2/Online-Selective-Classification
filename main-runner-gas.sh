...
#python main_runner_varying_Ts_experiment.py --n_runs $n_runs --dataset cifar --data ../data/ --scheme 1 --theta 0.005
#python main_runner_varying_Ts_experiment.py --n_runs $n_runs --dataset gas --data ../data/GAS/ --scheme 1 --theta 0.001
#python main_runner_varying_Ts_experiment.py --n_runs $n_runs --dataset gas --data ../data/GAS/ --scheme 2 --theta 0.001
#python main_runner_varying_Ts_experiment.py --n_runs $n_runs --dataset gas --data ../data/GAS/ --scheme 1 --theta 0.005
#python main_runner_varying_Ts_experiment.py --n_runs $n_runs --dataset gas --data ../data/GAS/ --scheme 2 --theta 0.005

#python main_runner_varying_Ts_experiment.py --n_runs $n_runs --dataset gas --data ../data/GAS/ --scheme 1 --theta 0.001

for th in $(seq 0.001 0.001 0.02)
do
    echo $th;
    python main_runner_varying_Ts_experiment.py --n_runs $n_runs --dataset cifar --data ../data/ --scheme 1 --theta $th;
    python main_runner_varying_Ts_experiment.py --n_runs $n_runs --dataset cifar --data ../data/ --scheme 2 --theta $th;

    python main_runner_varying_Ts_experiment.py --n_runs $n_runs --dataset gas --data ../data/GAS/ --scheme 1 --theta $th;
    python main_runner_varying_Ts_experiment.py --n_runs $n_runs --dataset gas --data ../data/GAS/ --scheme 2 --theta $th;
done
...
#python main_runner_varying_prob_p_theta_experiment.py --n_runs $n_runs --dataset gas --data ../data/GAS/ --scheme 1
#python main_runner_varying_prob_p_theta_experiment.py --n_runs $n_runs --dataset gas --data ../data/GAS/ --scheme 2
